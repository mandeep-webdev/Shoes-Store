        ...
        <div className="flex flex-col lg:flex-row md:px-10 gap-[50px] lg:gap-[100px]">
          ...
          <div className="flex-[1] py-3">
              ...
              {p.original_price && (
                <>
                  ...
                  <p className="ml-auto text-base font-medium text-green-500">
                    {calDiscountPercentage(p.original_price, p.price)}% off
                  </p>
                </>
              )}
            </div>
            ...
            <div className="mb-10">
              ...
              <div id="sizesGrid" className="grid grid-cols-4 gap-3">
                {p.size.data.map((item, i) => (
                  <div
                    key={i}
                    className={`border  rounded-full h-16 w-16 mt-2 bg-gray-100 text-center py-3 font-bold ${
                      item.enabled
            ...
            <button
              ...
              onClick={() => {
                // !selectedSize && setShowError(true);
                if (!selectedSize) {
                  setShowError(true);
            ...
            <div>
              ...
              <div className="markdown text-md mb-5 mt-5">
